        ...
        const fetchPlaylist = async (retryCount = 0) => {
            ...
            if (cachedData) {
                dispatch({
                    ...
                    playlistWithTracks: { ...playlistWithTracks, [id]: JSON.parse(cachedData) },
                });
                return;
            }
            ...
            try {
                ...
                dispatch({
                    type: 'SET_PLAYLIST_WITH_TRACKS',
                    playlistWithTracks: { ...playlistWithTracks, [id]: playlistData.data.items },
                });
                localStorage.setItem(`playlist_${id}`, JSON.stringify(playlistData.data.items));
                setError(null);
            } catch (error) {
    ...
    return (
        <div className="playlist">
            ...
            <div className="tracks-holder">
                ...
                {playlistWithTracks[id]?.map((track) => (
